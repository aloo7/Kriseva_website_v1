...
.brand{display:flex;align-items:baseline;gap:10px;font-family:'IBM Plex Mono',monospace;
  font-size:24px;letter-spacing:.34em;font-weight:500}
.tika{width:11px;height:11px;border-radius:50%;background:#A87229;display:inline-block}
...
<div class="frame"></div>
<div class="brand">KRISEVA<span class="tika"></span></div>
